...
class Post(models.Model): #models.Model means that the Post is a Django Model, so Django knows that it should be saved in the database.
    author = models.ForeignKey('auth.User', on_delete=models.CASCADE) #models.ForeignKey – this is a link to another model.
    ...
    created_date = models.DateTimeField( #models.DateTimeField – this is a date and time.
